            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: const Icon(Icons.flight_takeoff, color: MFColors.brand, size: 38),
                ),
              ),
              ...
              _Field(label: '账号 / 邮箱', controller: _account, hint: '请输入账号或邮箱'),
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  Switch(value: _autoLogin, onChanged: (v) => setState(() => _autoLogin = v)),
                ],
              ),
